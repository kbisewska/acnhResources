...
final class Bug: Object, Codable {
    ...
    @objc dynamic var flickPrice: Int = 0
    ...
    required convenience init(from decoder: Decoder) throws {
        ...
        flickPrice = try container.decode(Int.self, forKey: .flickPrice)
    ...
    func encode(to encoder: Encoder) throws {
        ...
        try container.encode(flickPrice, forKey: .flickPrice)
